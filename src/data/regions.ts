...
export const FYLKER: Fylke[] = [
  ...
  {
    navn: "Oslo",
    kommuner: [{ nummer: "0301", navn: "Oslo" }],
  },
  {
    navn: "Rogaland",
    kommuner: [
  ...
  },
  {
    ...
    kommuner: [
      ...
      { nummer: "5050", navn: "Leka" },
      { nummer: "5052", navn: "Inderøy" },
      { nummer: "5053", navn: "Indre Fosen" },
      { nummer: "5054", navn: "Heim" },
      { nummer: "5055", navn: "Hitra" },
      { nummer: "5056", navn: "Ørland" },
      { nummer: "5057", navn: "Åfjord" },
      { nummer: "5058", navn: "Orkland" },
      { nummer: "5059", navn: "Nærøysund" },
    ],
  },
  {
    navn: "Viken",
    kommuner: [
      ...
      { nummer: "3501", navn: "Moss" },
      { nummer: "3502", navn: "Fredrikstad" },
      { nummer: "3503", navn: "Sarpsborg" },
      { nummer: "3505", navn: "Halden" },
      { nummer: "3507", navn: "Hvaler" },
      { nummer: "3508", navn: "Aremark" },
      { nummer: "3509", navn: "Marker" },
      { nummer: "3510", navn: "Indre Østfold" },
      { nummer: "3511", navn: "Skiptvet" },
      { nummer: "3512", navn: "Rakkestad" },
      { nummer: "3513", navn: "Råde" },
      { nummer: "3514", navn: "Våler" },
    ],
  },
  {
    ...
    kommuner: [
      ...
      { nummer: "3802", navn: "Holmestrand" },
      { nummer: "3803", navn: "Tønsberg" },
      { nummer: "3804", navn: "Sandefjord" },
      { nummer: "3805", navn: "Larvik" },
      { nummer: "3806", navn: "Porsgrunn" },
      { nummer: "3807", navn: "Skien" },
      { nummer: "3808", navn: "Notodden" },
      { nummer: "3811", navn: "Færder" },
      { nummer: "3812", navn: "Siljan" },
      { nummer: "3813", navn: "Bamble" },
      { nummer: "3814", navn: "Kragerø" },
      { nummer: "3815", navn: "Drangedal" },
      { nummer: "3816", navn: "Nome" },
      { nummer: "3817", navn: "Midt-Telemark" },
      { nummer: "3818", navn: "Tinn" },
      { nummer: "3819", navn: "Hjartdal" },
      { nummer: "3820", navn: "Seljord" },
      { nummer: "3821", navn: "Kviteseid" },
      { nummer: "3822", navn: "Nissedal" },
      { nummer: "3823", navn: "Fyresdal" },
      { nummer: "3824", navn: "Tokke" },
      { nummer: "3825", navn: "Vinje" },
    ],
  },
  {
    navn: "Agder",
  ...
  },
  {
    ...
    kommuner: [
      ...
      { nummer: "5520", navn: "Salangen" },
      { nummer: "5522", navn: "Dyrøy" },
      { nummer: "5524", navn: "Senja" },
      { nummer: "5526", navn: "Sørreisa" },
      { nummer: "5528", navn: "Bardu" },
      { nummer: "5530", navn: "Målselv" },
  ...
  },
  {
    ...
    kommuner: [
      ...
      { nummer: "5607", navn: "Vardø" },
      { nummer: "5610", navn: "Vadsø" },
      ...
      { nummer: "5624", navn: "Karasjok" },
      { nummer: "5626", navn: "Lebesby" },
      { nummer: "5628", navn: "Gamvik" },
      { nummer: "5630", navn: "Berlevåg" },
      { nummer: "5632", navn: "Tana" },
      { nummer: "5634", navn: "Nesseby" },
      { nummer: "5636", navn: "Båtsfjord" },
    ],
  },
];

export function getKommunenummerForFylke(fylke: string): string[] {
  const f = FYLKER.find((f) => f.navn === fylke);
  return f ? f.kommuner.map((k) => k.nummer) : [];
}
