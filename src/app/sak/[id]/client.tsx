...
export function ArticlePageClient({ id }: { id: string }) {
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-3xl mx-auto px-6 py-24 text-center">
          ...
          <a href="/" className="px-6 py-2.5 bg-accent text-accent-foreground rounded-full font-subhead text-sm font-semibold hover:bg-accent/90 transition-colors shadow-soft inline-block">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <article className="max-w-xl mx-auto px-6 pt-10 pb-14">
        ...
        <h1 className="font-headline text-2xl md:text-3xl lg:text-4xl font-bold text-headline leading-[1.15] mb-6 animate-fade-up" style={{ animationDelay: "100ms", animationFillMode: "both" }}>
          {title}
        </h1>
