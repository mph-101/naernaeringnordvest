...
Plassholdere markert med `[KLAMMER]` må fylles inn før publisering.
...
Vi vil gjerne høre fra deg — enten du har et tips, et spørsmål, en korrigering eller bare en mening om noe vi har skrevet.

**Redaksjonen**
Tips, innspill og spørsmål til redaksjonelt innhold:
[redaksjon@naernaering.no]

**Tips oss anonymt**
Har du sensitive opplysninger? Vi tar imot tips fortrolig og beskytter kildene våre etter pressens kildevernregler. Bruk [SecureDrop / kryptert e-post / annen sikker kanal] eller kontakt en av journalistene våre direkte.

**Rettelser og klager**
Mener du noe vi har publisert er feil eller urimelig? Skriv til ansvarlig redaktør på [redaktor@naernaering.no]. Du kan også klage oss inn for Pressens Faglige Utvalg (PFU). Mer om dette under [Redaksjonelle prinsipper](#redaksjonelle-prinsipper).

**Annonsering og kommersielle henvendelser**
[salg@naernaering.no] — eller ring [TELEFON]

**Abonnement og kundeservice**
[kundeservice@naernaering.no]
...
Kontakt: [personvern@naernaering.no]
...
Vi bruker informasjonskapsler (cookies) og lignende teknologi for å levere og forbedre tjenesten. Du kan velge hvilke cookies du godtar via cookie-bannerets innstillinger. Se egen [cookie-erklæring] for detaljer.
...
For å utøve rettighetene dine, kontakt oss på [personvern@naernaering.no]. Du har også rett til å klage til Datatilsynet ([datatilsynet.no](https://datatilsynet.no)).
...
## Impressum (footer-tekst)

Kort tekst til footeren — vis sammen med logo og lenker til de øvrige sidene. Bruk én av variantene under, eller miks etter behov.
...
> Medlem av MBL og Norsk Redaktørforening. Tilsluttet PFU. Arbeider etter Vær Varsom-plakaten og Redaktørplakaten.
> © Compass Media [ÅR]. Materialet er vernet etter åndsverkloven. Uten avtale med Compass Media er enhver eksemplarfremstilling og tilgjengeliggjøring kun tillatt i den utstrekning det er hjemlet i lov eller tillatt gjennom avtale med Kopinor.
